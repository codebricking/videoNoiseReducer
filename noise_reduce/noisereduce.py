from noise_reduce.spectralgate.stationary import SpectralGateStationary
from noise_reduce.spectralgate.nonstationary import SpectralGateNonStationary
...
if TORCH_AVAILABLE:
    from noise_reduce.spectralgate.streamed_torch_gate import StreamedTorchGate
